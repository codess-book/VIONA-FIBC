...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-gradient-to-b from-[#0B0C10] via-[#0f172a] to-[#050816] border-t border-white/5 shadow-[0_-4px_20px_rgba(59,130,246,0.15)]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-10 pb-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col space-y-2">
            <h3 className="font-serif text-sm font-bold uppercase tracking-[0.15em] text-white border-b-2 border-blue-500/40 pb-1.5 w-fit">
              Address
            </h3>
            <div className="flex flex-col space-y-1.5 text-sm text-slate-400 font-sans">
              <div className="flex items-start gap-2">
                ...
                <p className="leading-snug">
                  <span className="font-semibold text-slate-200">Office Address:</span><br />
                  15/2 Tatya Tope Marg,<br />
                  Freeganj, Ujjain - 456010,<br />
                  Madhya Pradesh (India)
                </p>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-3.5 w-3.5 text-blue-400" />
                <a href="mailto:info@vionafibc.com" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  info@vionafibc.com
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="h-3.5 w-3.5 text-blue-400" />
                <a href="tel:+917992392070" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  +91 7992392070
                </a>
              </div>
            </div>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex flex-col space-y-0.5 text-sm text-slate-400 font-sans">
              <p>Mon - Sat: <span className="font-medium text-slate-200">8am – 7pm</span></p>
              <p>Sunday: <span className="font-medium text-red-400">Closed</span></p>
            </div>
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-serif text-xl font-bold tracking-tight text-white">VIONA</span>
            </div>
            
            <p className="text-sm leading-relaxed text-slate-400 font-sans">
              VIONA-FIBC Pvt. Ltd. – India based manufacturer of premium Big Bags, driven by innovation and technology.
            </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-4 sm:flex-row">
          ...
          >
            Developed &amp; Designed by <span className="text-blue-400 hover:text-blue-300 transition-colors">codes.book</span>
          </motion.p>
        </div>
      </div>
    </footer>
